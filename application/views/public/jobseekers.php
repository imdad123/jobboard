        ...
        <header>
            <div class="blog-bg">
                <div class="blog-overlay">
                    ...
                    <h1 class="white text-center">Home | Jobseekers</h1>
                       <h4 class="white text-center mgr-top-20"><strong>Find a Jobseekers</strong></h4>
...
<form action="<?php echo site_url("front/jobseekers");?>" method="post" style="display:none;">    
                    ...
                    <div class="row mgr-top-40">
                            <div class="col-md-4"></div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="skill" id="" class="form-control" placeholder="Skills,jobseeker Name">
                                </div>
                                 <div class="col-md-4">
                                    <input type="submit" name="search" value="Find a jobseekers" id="sub-btn" class="btn btn-success">
                                </div>
    ...
    <section class="blog" id="blog">
        <div class="container mgr-top-40 ">
            <div class="row mgr-top-60" id="mentor-fa">
                <h2 class="text-center "><strong>Jobseekers</strong></h2>
                <hr>
                <?php foreach($view_jobseeker as $key=>$jobseeker):?>
                 <?php if( $jobseeker->jobseeker_id % 2 == 0): ?>
                 <a href="<?php echo site_url("front/jobseeker_single/").$jobseeker->jobseeker_id;?>">
                <div class="col-md-3 col-md-offset-1 mgr-top-40 box">
                    <img src="<?php echo $jobseeker->image;?>" class="img-responsive" alt="">
                   ...
                   <div class="col-md-4">
                    ...
                    <div class="col-md-5">
                        <p><?php echo substr($jobseeker->jobseeker_about,0,50); ?></p>
                    </div>
