    ...
    <section class="blog" id="blog">
        <div class="container mgr-top-40 ">
            ...
            <div class="col-md-10 col-md-offset-2">
               <?php foreach($single_category as $key=>$question):?>
                <h4 >Question<?php echo " ".$key." ";  ?>:  <?php echo "<strong>".$question->question_text."</strong> ";?></h4>
                
                <h4 class="mgr-top-20">Answer <?php echo " ".$key."  "; ?>:<?php echo $question->question_answer;?></h4>
                <?php endforeach; ?>
            </div>
            <div class="row">
